...
- The notch can show a wave of your voice while you talk, growing from its right side only. Settings → Voice folds into collapsible cards in a sensible order, its controls show on light themes, the upload model is labelled as the fallback it is, and a voice log entry copies on click.
